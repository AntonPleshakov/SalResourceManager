...
RELEASES: Tuple[Release, ...] = (
    ...
    Release(
        ...
        changes=(
            "Добавлена поддержка нескольких кланов: игровые данные, права "
            "администраторов, рассылки и Google-отчёты разделены по кланам.",
            "Бот проверяет актуальное участие игроков и администраторов в "
            "клане и автоматически отзывает устаревшие права.",
            "Упрощено заполнение и редактирование ресурсов.",
            "В рассылках добавлен выбор пользователей по давности обновления ресурсов.",
            "Расчёт войны теперь учитывает обновления ресурсов с начала недели.",
            "Напоминания о ресурсах теперь приходят только по понедельникам.",
            "Обновлено оформление страниц и формат дат.",
        ),
    ),
    Release(
        version="1.9.0",
        released_on=date(2026, 9, 10),
        changes=(
            "Обновлены оформление, навигация и тексты в основных разделах бота.",
            "Добавлен учёт колб и шанса бесплатной ковки снаряжения.",
            "Администраторы могут настроить клановые технологии, а калькулятор войны учитывает их бонусы.",
            "Клановый расчёт войны отдельно показывает подтверждённые и возможные очки.",
            "Обновлены просмотр и экспорт игровых данных в Google Таблицы.",
            "Игровые аккаунты автоматически отвязываются от клана после выхода игрока.",
        ),
    ),
)
